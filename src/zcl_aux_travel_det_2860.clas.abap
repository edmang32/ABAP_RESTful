CLASS zcl_aux_travel_det_2860 DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .

  PUBLIC SECTION.
    TYPES: tt_travel_reported      TYPE TABLE FOR REPORTED zi_travel_2860,
           tt_booking_reported     TYPE TABLE FOR REPORTED zi_booking_2860,
           tt_supplements_reported TYPE TABLE FOR REPORTED zi_bookingsuppl_2860,
...
CLASS ZCL_AUX_TRAVEL_DET_2860 IMPLEMENTATION.
  ...
  METHOD calculate_price.
    ...
    READ ENTITIES OF zi_travel_2860
         ENTITY Booking BY \_BookingSplmnt
    ...
    MODIFY ENTITIES OF zi_travel_2860 ENTITY Travel
